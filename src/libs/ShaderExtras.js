...
THREE.ShaderExtras = {
	...
	Godrays: {
		uniforms: {
			...
			fX: {type: "f", value: 0.5},
			fY: {type: "f", value: 0.5},
			fExposure: {type: "f", value: 0.38},
			fDecay: {type: "f", value: 0.94},
			fDensity: {type: "f", value: 0.79},
			fWeight: {type: "f", value: 0.38},
		...
		fragmentShader: [
			...
			"{",
				...
				"{",
					...
					"vec3 texel = texture2D(tDiffuse, coord).xyz;",
	...
	Additive: {
		...
		fragmentShader: [
			...
			"void main() {",
				...
				"gl_FragColor = vec4(add.rgb+texel.rgb,1.);",
...
exports.ShaderExtras =  THREE.ShaderExtras